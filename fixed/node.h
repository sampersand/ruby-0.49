...
#define NEW_GASGN(v,val) newnode(NODE_GASGN,v,val,__r49_cast(NODE*, struct global_entry *, rb_global_entry(v)))
...
#define NEW_GVAR(v) newnode(NODE_GVAR,v,Qnil,__r49_cast(NODE*, struct global_entry *, rb_global_entry(v)))
