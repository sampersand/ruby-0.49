...
LDFLAGS =  $(CFLAGS)
LIBS = 
DEFS =  -DHAVE_UNISTD_H=1 -DVOID_CLOSEDIR=1 -DGETGROUPS_T=int -DRETSIGTYPE=int -DTM_IN_SYS_TIME=1 -DC_ALLOCA=1 -DSTACK_DIRECTION=0 -DWORDS_BIGENDIAN=1 \
	-DHAVE_MEMMOVE -DHAVE_STRERROR -DHAVE_STRTOUL -DHAVE_STRFTIME -DHAVE_STRSTR -DHAVE_GETOPT_LONG -DHAVE_MKDIR -DHAVE_STRDUP
